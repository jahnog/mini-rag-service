...
On the host: `sudo systemctl start bcra-rag`, `sudo systemctl stop bcra-rag`, `sudo systemctl status bcra-rag`, `sudo systemctl start bcra-rag-ingest`, `sudo systemctl start bcra-rag-refresh`.
