...
def test_footer_uses_date_prefix() -> None:
    ...
    assert freeze_footer(None, None) == (
        "Según el extracto de un día desconocido (texto ordenado a un dato desconocido)."
    )
...
def test_names_freeze_accepts_iso_or_date() -> None:
    ...
    assert names_freeze("Según el extracto del 2026-09-01 (texto ordenado al A8307).", iso, "A8307")
